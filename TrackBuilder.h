...
public:
	...
	void SetControlPoint(int control_point, const SL::Vector& values);
	...
	void SetP0(const SL::Vector& values);
	void SetP1(const SL::Vector& values);
	void SetP2(const SL::Vector& values);
	void SetP3(const SL::Vector& values);
